        ...
        <Sidebar.Pushable as={Segment} className={styles.sidebar}>
          ...
          <Sidebar.Pusher>
            <Segment basic>
              ...
              <Tools currTool={this.props.currTool} grid={this.props.grid} changeCurrentTool={this.props.changeCurrentTool} toolsConfig={this.props.toolsConfig} cleanCanvas={this.props.cleanCanvas} onImageLoad={this.props.onImageLoad} canvasSize={this.props.canvasSize} />
            </Segment>
          </Sidebar.Pusher>
        </Sidebar.Pushable>
      </div>
