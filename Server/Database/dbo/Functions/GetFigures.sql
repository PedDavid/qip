...
as
	return(
		select fig.boardId, fig.id, fig.figureType, lineX.isClosedForm, lineX.lineStyleId, lineX.pointId, lineX.pointStyleId,
			...
			from dbo.Figure as fig 
				...
				full outer join 
				(select lin.figureId, lin.boardId, lin.isClosedForm, lin.lineStyleId, figP.pointId, figP.pointStyleId from dbo.Line as lin
